...
alias sru="python -m sagas.tool.misc trans_clip ru 'en;zh-CN;ja' ja False"
...
alias sfr="python -m sagas.tool.misc trans_clip fr 'en;zh-CN;ja' ja False"
...
alias sde="python -m sagas.tool.misc trans_clip de 'en;zh-CN;ja' ja False"
...
alias sen="python -m sagas.tool.misc trans_clip en 'fr;zh-CN;ja' en False"
...
alias sj="python -m sagas.tool.misc trans_clip ja 'en;zh-CN' en False"
alias sja="engine=stanza python -m sagas.tool.misc trans_clip ja 'en;zh-CN' ja False"
...
alias str="python -m sagas.tool.misc trans_clip tr 'en;zh' en False"
...
alias shr="python -m sagas.tool.misc trans_clip hr 'en;zh-CN;ja' en False"
...
alias cvi='python -m sagas.nlu.nlu_tools tree_comp _ vi'
alias car='python -m sagas.nlu.nlu_tools tree_comp _ ar'
