...
class NlpProcsStub(object):
  ...
  def __init__(self, channel):
    ...
    self.Ping = channel.unary_unary(
        ...
        request_serializer=nlpserv__pb2.PingRequest.SerializeToString,
        response_deserializer=nlpserv__pb2.PingReply.FromString,
        )
...
def add_NlpProcsServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'Ping': grpc.unary_unary_rpc_method_handler(
          servicer.Ping,
          request_deserializer=nlpserv__pb2.PingRequest.FromString,
          response_serializer=nlpserv__pb2.PingReply.SerializeToString,
      ),
